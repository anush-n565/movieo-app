    ...
    return (
        <div className='container mx-auto px-3 my-10'>
            ...
            <div className='relative'>
                <div ref={containerRef} className='grid grid-cols-[repeat(auto-fit,230px)] grid-flow-col gap-6 overflow-hidden overflow-x-auto relative z-10 scroll-smooth transition-all no-scrollbar'>
                    {
                        data.map((item, index) => {
                            return (
